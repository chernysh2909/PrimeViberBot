...
def incoming():
    ...
    if isinstance(viber_request, ViberMessageRequest):
        ...
        elif str(SESSION['client_compani'] == 'Prime1' print(SESSION['client_compani'])) and message.text == 'Наші реквізити':
...
Пошта: manager@prime.net.ua''', keyboard=smm_keyboard)])
        elif str(SESSION['client_compani'] == 'Prime2' print(SESSION['client_compani'])) and message.text == 'Наші реквізити':
            viber.send_messages(viber_request.sender.id, [TextMessage(text=
